...
<div class="flex justify-center item-center">
    <form method="POST" action="/sample" class="w-6/12" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex justify-center item-center pb-4">
            <button class="px-8 py-2 font-semibold rounded-lg bg-dongker border-2 border-[#123C69] text-white hover:bg-dongker/40 hover:border-[#123C69]/40"
                type="submit">Submit
            </button>
        </div>
    </form>
