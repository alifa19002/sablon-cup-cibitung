...
<div class="flex justify-center item-center mt-8">
    <h1 class="text-2xl font-bold">Form Tambah Sampel</h1>
</div>
    ...
    <form method="POST" action="/sample" enctype="multipart/form-data">
        ...
        <div class="bg-abu rounded-lg">
            <div class="m-10 py-10">
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    <div class="w-44 font-bold h-6 mx-2 mt-3">Foto/Gambar Sampel</div>
                    <div class="flex-1 flex flex-col md:flex-row">
                        <div class="w-full flex-1 mx-2">
                            <!-- <div class="my-2 p-1 bg-white flex border border-gray-200 rounded"> -->
                            <input type="file" id="photo" name="photo" class="bg-white rounded-xl block w-full p-2.5">
                            <!-- </div> -->
                        </div>
                    </div>
                </div>
        ...
        <div class="flex justify-center item-center pb-4">
            <button class="px-8 py-2 font-semibold rounded-lg bg-dongker border-2 border-[#123C69] text-white hover:bg-dongker/40 hover:border-[#123C69]/40" type="submit">Submit
            </button>
        </div>
    </form>
</div>
